...
def experiment():
    for model in models:
        for train_set in train_data:
            ...
            train_features = load_features(f"data/dataset/features/{train_set}_{model}.npz")
            train_labels = load_labels(f"data/dataset/{train_set}/", label_column="label")
            ...
            for test_set in test_data:
                test_features = load_features(
                    f"data/dataset/features/{test_set}_{model}.npz"
                )
                ...
                save_predictions_npz(
                    f"data/dataset/features/{test_set}_{model}.npz",
                    test_preds,
                    f"preds/{test_set}_{model}_{train_set}.npz",
                )
